...
TwitterURL = "https://api.tracks8.com"

//------------------------------------------------------------------------------
tracks8 = exports

tracks8.init           = init
tracks8.getTweets      = getTweets
tracks8.getTwitterInfo = getTwitterInfo

//------------------------------------------------------------------------------
function init(config, cb) {
  utils.log("initializing 8tracks")
  cb(new Error("8tracks: woops"))
}

//------------------------------------------------------------------------------
function init2(key, secret, callback) {
  var creds
  ...
  httpsRequest(options, data, function(err, data) {
    if (!err) {
      ...
      utils.log("tracks8 bearer token retrieved")
    }
...
//------------------------------------------------------------------------------
function getTweets(twitterSN, callback) {
